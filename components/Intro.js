    ...
    <section className="md:flex bg-white md:flex-row-reverse items-center">
      <div className="md:flex-[50%] lg:flex-[60%] px-4 md:px-6">
        <h1 className="text-2xl lg:text-4xl font-thin text-center">
          Hello{" "}
          <span className="font-semibold text-indigo-600">I'm Pavan </span>{" "}
        </h1>

        <p className="text-center text-sm md:text-sm lg:text-base mt-2 font-sans">
      ...
      <div className="mt-4 md:mt-0 md:flex-[50%] lg:flex-[40%] px-3">
